...
{
    public class SkuInfoDto : FullEntity
    {
        public SkuInfoDto()
        {
        ...
        /// 配置总数
        /// </summary>
        public string CofigCount { get; set; }

        public List<SkuComponentTreeDto> PartChildren;
        public List<SkuComponentTreeDto> FittingChildren;
        public List<SkuComponentTreeDto> FittingChildrenLeft;
        public List<SkuComponentTreeDto> FittingChildrenRight;
