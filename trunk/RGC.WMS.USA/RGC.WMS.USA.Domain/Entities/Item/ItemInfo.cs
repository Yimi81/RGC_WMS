...
namespace RGC.WMS.USA.Domain.Entities.Item
{
    ...
    public class ItemInfo : FullEntity
    {
        ...
        [NotMapped]
        public Dictionary<long, ItemModifyFlow> FlowDict { get; set; }
    }


    public class PlatformItemObj
    {
        public long platformId { get; set; }
        public string platformName { get; set; }
