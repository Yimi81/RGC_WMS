#pragma checksum "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Sku\Class.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d1543784fdec985dbbc585a171effa7320286742"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Sku_Class), @"mvc.1.0.view", @"/Views/Sku/Class.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d1543784fdec985dbbc585a171effa7320286742", @"/Views/Sku/Class.cshtml")]
    ...
    public class Views_Sku_Class : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Sku\Class.cshtml"
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d1543784fdec985dbbc585a171effa73202867424578", async() => {
        ...
        <el-row>
            ...
            ");
                WriteLiteral(@"                <el-input v-model=""editForm.eName"" auto-complete=""off""></el-input>
                        </el-form-item>
                     ...
                     ");
                WriteLiteral("       <el-upload class=\"m-t-10 avatar-uploader\"");
            ...
            ");
                WriteLiteral(@"    <el-table :data=""skuForm.items"" size=""small"" highlight-current-row v-loading=""listLoading"" style=""width: 100%;margin-top:10px;"">
                    ...
                    <el-table-column prop=""factoryModel"" lab");
                WriteLiteral(@"el=""型号""></el-table-column>
        ...
        <el-dialog title=""添加Sku"" :visible.sync=""skuFormVisible"" :close-on-click-modal=""false"" width=""60%"">
            ...
            <el-row class=""mt10"">
                <article class=""search"">
                    <section>
                        <el-input placeholder=""关键字搜索"" si");
                WriteLiteral(@"ze=""mini"" v-model=""filters.searchKey""
            ...
            <el-table :data=""skuForm2.items"" size=""small"" highlight-current-row v-loading=""listLoading"" style=""width: 100%;margin-top:10px;"">
                ...
                <el-table-column min-width=""380"" prop=""fullEName"" label=""商品名"">
                    <template slot-scope=""scope"">
                        ...
                        <el-popover placement=""right""
                                    trigger=""hover"">
                            <img :src=""scope.row.primaryImageSrcFull"" class=""pi");
                WriteLiteral(@"mg"" alt=""no image"" v-if=""scope.row.primaryImageSrcFull!=''"" width=""250"">
                            <i slot=""reference"">{{scope.row.fullEName}}</i>
                        </el-popover>
                    </template>
                </el-table-column>
  ...
  ");
                WriteLiteral(@"          <el-cascader expand-trigger=""hover""
                         :options=""cascader""
                         v-model=""categoryIds""
                          size=""small""
                         class=""minw250 mb30"">
            ...
            data() {
                return {
                    ...
                    editFormRules: {
                        eName: [
                            { re");
                WriteLiteral(@"quired: true, message: '请输入英文名', trigger: 'blur' }
                        ],
    ...
    ");
        ...
        ");
                WriteLiteral(@"                            _self.skuForm2.items = data.data.list;
                                } else {
                                    _self.$notify.error({
                                        title: '错误',
                                        message: data.msg
            ...
            ");
                ...
                editSkuClass() {
                    ...
                    $.ajax({
                        ...
                        data: { category");
                WriteLiteral(@"Id: _self.categoryIds[_self.categoryIds.length - 1], skuId: _self.skuId },
                        success: function (data) {
                            if (data.success) {
                                _self.$message({
                                    type: 'success',
                ...
                WriteLiteral(@"{
                        ...
                        error: function (XMLHttpRequest, textStatus, errorThrown) {
                            if (errorThrown == ""Unauthorized"") {
                                ...
                                _self.$message({
                                    type: 'error',
                                    message: XMLHttpRequest.re");
                WriteLiteral(@"sponseJSON.msg
                                });
                            } else {
                                _self.$message({
                                    type: 'error',
           ...
           ");
                WriteLiteral(@"                             click: function () {
                                            ...
                                            _self.srcFull = """";
                                         ");
                WriteLiteral(@"   _self.editForm.byteStr = """";
                                        }
                                    }
                                }),
                                createElement('el-button', {
                                    attrs: {
                                        ...
                                        click: function () {
                                            ...
                                            _self.editFormVisible = true;
                                 ");
                WriteLiteral(@"           _self.editForm.isShow = data.isShow;
        ...
        ");
                WriteLiteral(@"                        }),
                                ...
                                cr");
                WriteLiteral(@"eateElement('el-button', {
                                    attrs: {
                                        size: ""mini"",
                                        disabled: noeditdel,
                                        plain: true,
                ...
                editSubmit() {
                   ...
                   ");
                WriteLiteral(@"                     _self.editFormVisible = false;
                                        if (data.success) {
                                            _self.$message({
                                                type: 'success',
                                                message: '新增成功!'
                ...
                WriteLiteral(@"                                   window.parent.MainIndex.openLoginFrom();
                            ...
                            //编辑
                                ...
                                $.ajax({
                                    ...
                                    dataType: 'json',
                   ");
                WriteLiteral(@"                 url: '../../rest/category/update',
