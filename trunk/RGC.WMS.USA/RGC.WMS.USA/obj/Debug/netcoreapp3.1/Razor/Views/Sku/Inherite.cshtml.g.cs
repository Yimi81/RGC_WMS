#pragma checksum "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Sku\Inherite.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a73d10f8c8c4f0b6671f75d1942db1e06a7c8fdf"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Sku_Inherite), @"mvc.1.0.view", @"/Views/Sku/Inherite.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a73d10f8c8c4f0b6671f75d1942db1e06a7c8fdf", @"/Views/Sku/Inherite.cshtml")]
    ...
    public class Views_Sku_Inherite : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Sku\Inherite.cshtml"
  
    ViewBag.Title = "Inherite";
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "a73d10f8c8c4f0b6671f75d1942db1e06a7c8fdf6044", async() => {
                WriteLiteral("\r\n    <div id=\"wrapper\">\r\n        <!-- 标题和地址 -->\r\n        <el-row>\r\n            <el-col :span=\"24\" class=\"breadcrumb-container\">\r\n");
                WriteLiteral("                <el-breadcrumb separator=\"/\">\r\n");
                WriteLiteral(@"                    <el-breadcrumb-item><strong>Sku管理</strong></el-breadcrumb-item>
                    <el-breadcrumb-item>Sku添加</el-breadcrumb-item>
                </el-breadcrumb>
            </el-col>
        </el-row>
        <template>
            <article class=""administration-maintenance-container"" v-loading=""loading"">
                <div ref=""nav_sku"" id=""nav_sku"">
                    <el-button type=""primary"" size=""medium"" class=""savebtn"" v-on:click=""save"" v-loading=""loading"">保 存</el-button>
         ...
         ");
                WriteLiteral("                               <el-input v-model=\"currProduct.factoryModel\" readonly class=\"w180\"></el-input>\r\n                                    </el-form-item>\r\n");
                WriteLiteral(@"                                    <el-form-item label=""Category(产品类型)"" prop=""funcCategoryIds"" :rules=""[{ required: true, message: '请选择', trigger: 'blur' }]"">
                                        <el-cascader expand-trigger=""hover""  class=""w180""
                                                     :options=""cascader""
                ...
                WriteLiteral(@"                                                     clearable>
                                    ...
                                    <el-form-item label=""SKU"">
                                        <el-input v-model.trim=""currProduct.sku"" readonly class=""w180""></el-input>
                                    </el-form-item>
                                    <el-form-item label=""UPC"">
                                        <el-input v-model.trim=""currProduct.upc"" readonly class=""w180""></el-input>
                                    </el-form-item>
                                    <el-form-item label=""Certification(认证)"">
                                        <el-input v-model.trim=""currProduct.certification"" readonly class=""w180""></el-input>
                                    </el-form-item>
");
                WriteLiteral(@"                                    <el-form-item label=""Package Configuration(包装配置)"">
                                        <el-input v-model.trim=""currProduct.packingConfig"" readonly class=""w180""></el-input>
                                    </el-form-item>
                                    <el-row>
                                        <el-form-item label=""Product Dimension(产品尺寸)"">
                                            <el-input-number :controls=""false"" :precision=""2"" placeholder=""0.00""  :min=""0.00"" v-model.trim=""currProduct.productSizeLength"" disabled></el-input-number>
                                            -
                                            <el-input-number :controls=""false"" :precision=""2"" placeholder=""0.00""  :min=""0.00"" v-model.trim=""currProduct.productSizeWidth"" disabled></el-input-number>
                                            -
                                            <el-input-number :controls=""false"" :precision=""2"" placeholder=""0.00""  :min=""0.00"" v-mo");
                WriteLiteral(@"del.trim=""currProduct.productSizeHeight"" disabled></el-input-number>
                                            <el-tag type=""info"" size=""small"">inch</el-tag>
                                        </el-form-item>
                                    </el-row>
                                    <el-row>
                                        <el-form-item label=""Product Dimension (包装尺寸)"">
                                            <el-input-number :controls=""false"" :precision=""2"" placeholder=""0.00""  :min=""0.00"" v-model.trim=""currProduct.packingSizeLength"" disabled></el-input-number>
                                            -
                                            <el-input-number :controls=""false"" :precision=""2"" placeholder=""0.00""  :min=""0.00"" v-model.trim=""currProduct.packingSizeWidth"" disabled></el-input-number>
                                            -
                                            <el-input-number :controls=""false"" :precision=""2"" placeholder=""0.00""  :min=""0.00"" v-mo");
                WriteLiteral(@"del.trim=""currProduct.packingSizeHeight"" disabled></el-input-number>
                                            <el-tag type=""info"" size=""small"">inch</el-tag>
                                        </el-form-item>
                                    </el-row>
                                    <el-form-item label=""Net Weight (净重)"" prop=""netWeight"">
                                        <el-input-number class=""w145"" controls-position=""right"" :precision=""1"" :step=""0.1"" :min=""0.0"" v-model.trim=""currProduct.netWeight"" disabled></el-input-number>
                                        <el-tag type=""info"" size=""small"">LB</el-tag>
                                    </el-form-item>
                                    <el-form-item label=""Gross Weight (毛重)"" prop=""grossWeight"">
                                        <el-input-number class=""w145"" controls-position=""right"" :precision=""1"" :step=""0.1"" :min=""0.0"" v-model.trim=""currProduct.grossWeight"" disabled>
                                        </el-");
                WriteLiteral(@"input-number>
                                        <el-tag type=""info"" size=""small"">LB</el-tag>
                                    </el-form-item>
                                    <el-form-item label=""qty/pallet(1托数量)"">
                                        <el-input-number class=""w180"" :controls=""false"" :precision=""0"" :min=""0.0"" v-model.trim=""currProduct.qtyPallet"" disabled>
                                        </el-input-number>
                                    </el-form-item>
                                    <el-form-item label=""qty/40HQ(40HQ装柜数)"">
                                        <el-input-number class=""w180"" :controls=""false"" :precision=""1"" :min=""0.0"" v-model.trim=""currProduct.loadingQty_40HQ"" disabled>
                                        </el-input-number>
                                    </el-form-item>
                ...
                WriteLiteral(@" v-on:click=""addProperty()"">添加自定义</el-button>
                                    </el-row>
                                    <br />
                                    <el-row class=""pl90"">
                                            ...
                                            <el-form-item v-for=""(item,index) in Custom"" :key=""index"">
                                                <el-row :gutter=""12"">
                                                    <el-col :span=""10"">
                                                        ...
                                                        <el-col :span=""12"">
                                         ");
                WriteLiteral(@"                   <el-input placeholder=""英文名称"" v-model.trim=""item.eName"" auto-complete=""off"" icon=""edit"">
                                                            </el-input>
                                                        </el-col>
                                                    </el-col>
                                                    <el-col :span=""10"">
        ...
        ");
                ...
                WriteLiteral(@"                                    <el-table empty-text="" "" max-height=""150""
                                    ...
                                    <el-table class=""data-table detail-table"" v-loading=""listLoading"" :data=""currProduct.partChildren"" :fit=""true"" border size=""min");
                WriteLiteral(@"i"" :show-header=""false"" style=""width: 100%;"">
                                        ...
                                        <el-table-column>
                                            <template slot-scope=""scope1"">
                                                <el-table :fit=""true""
                                                    ...
                                                    <el-table-colu");
                WriteLiteral(@"mn width=""200"" align=""center"">
                                                        <template slot-scope=""scope"">
                                                            {{scope.row.cName}}
                                                            <br />
                                                            {{scope.row.eName}}
                ...
                WriteLiteral(@"   <el-row>
                                                    ...
                                                    <el-table-column prop=""remarks"" align=""center"">
                                                        <template slot-scope=""scope"">
                                                            ...
                                                            <el-row>
                                  ");
                WriteLiteral(@"                              <el-input size=""small"" placeholder=""Remarks"" type=""textarea"" v-model=""scope.row.eRemarks"" style=""width: 100%;"" />
                                                            </el-row>
...
");
                ...
                WriteLiteral(@"                                                  :ref=""'gridTree'+scope.row.configId""
                                                                ...
                                                                <el-button v-on:click=""chooseDetail('gridTree'+scope.row.configId,scope1.$index,sco");
                WriteLiteral(@"pe.$index)"" :readonly=""gridData.length<=0"" size=""mini"" type=""success"" plain>选择</el-button>
                ...
                WriteLiteral(@"                                                  <el-button type=""danger"" size=""mini"" v-on:click=""scope2.row.detailList.splice(scope3.$index , 1)"" plain>确定</el-button>
                                                                ...
                                                                <el-tab");
                WriteLiteral(@"le-column prop=""remarks"" align=""center"">
                                                                    <template slot-scope=""scope3"">
                                                                        <el-row>
     ...
     ");
                ...
                WriteLiteral(@"              </el-form-item>
                     ...
                     ");
                WriteLiteral(@"                       <div class=""el-upload el-upload--text"">
...
");
            ...
            ");
                WriteLiteral(@"            </el-button>
                    ...
                    <el-dialog title=""配件添加"" :visible.sync=""fittingVisable"" :close-on-click-modal=""false"">
                        <el-button type=""primary"" size=""small"" class=""waves-effe");
                WriteLiteral(@"ct mr10"" v-on:click=""chooseFitting()"">
                            确定
                        </el-button>
                    ...
                    <el-dialog title=""附件 Attachment"" :visible.sync=""fileManageVisable"" :clo");
                WriteLiteral(@"se-on-click-modal=""false"" top=""5%"" width=""1000px"">
    ...
    <script>
        var Main = {
         ...
         ");
                        ...
                        error: function (XMLHttpRequest, textStatus, errorThrown) {
                            if (errorThrown == ""Unauthorized"") {
                                ...
                                $this.$message({
                                    type: 'error',
                                    message: XMLHtt");
                WriteLiteral(@"pRequest.responseJSON.msg
                                });
                            } else {
                                $this.$message({
                                    type: 'error',
                ...
                chooseDetail(refName");
                WriteLiteral(@",index1, index2) {
                    var _self = this
              ...
              ");
                ...
                getDetailList(row) {
                    ...
                    $.ajax({
                        ...
                        error: fun");
                WriteLiteral(@"ction (XMLHttpRequest, textStatus, errorThrown) {
                            if (errorThrown == ""Unauthorized"") {
                                window.parent.MainIndex.openLoginFrom();
                                _self.$message({
                                    type: 'error',
                ...
                partsTreeGetChecked() {
                    for (let parent of this.currProduct.partChildren) {
                        ...
                        if (parent.children.length > 0) {
                          //子级选中
                            for (let ch");
                WriteLiteral(@"ild of parent.children) {
    ...
    ");
                WriteLiteral(@"                                $this.currProduct.fittingChildren = data.data.fittingChildren
                                }
                            } else {
                                $this.$notify.error({
                                    title: '错误',
        ...
        ");
               ...
               ");
                ...
                addChild(index) {
                    this.Configuration[this.no].child.push(
                        {
                            index: this.no,
    ...
    ");
                ...
                getAllPackage() {
                    ...
                    $.ajax({
                        type: 'Get',
       ");
                WriteLiteral(@"                 url: '../../rest/sku/package',
                        success: function (data) {
                            if (data.success == true) {
                ...
                getPartsList() {
                    var $this = this;
              ");
                WriteLiteral(@"      $this.partVisable = true;
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.success == true) {
                                ...
                                $this.fit");
                WriteLiteral(@"tingTreeGetChecked()
                            } else {
                                $this.$notify.error({
                                    title: '错误',
                                    message: data.msg
...
");
                ...
                saveMainUrl() {
                    ...
                    if (selectedFilePath != undefined && se");
                WriteLiteral(@"lectedFilePath != """") {
                ...
                fileManageInitial() {
                    ...
                    var readonly = ['callback', 'chmod', 'editor', 'netmount', 'ping', 'search', 'zipdl', 'help']; // Not yet implemented commands in elFinder.NetCore
                    elFinder.prototype.i18.en.messages.TextArea = ""Edit"";

                    $.each(readonly, function (i, cmd) {
                        (idx = $.inArray(cmd, myCom");
                WriteLiteral("mands)) !== -1 && myCommands.splice(idx, 1);\r\n                    });\r\n\r\n                    var options = {\r\n                        url: \'/sku/connector\', // Default (Local File System)\r\n");
                                ...
                                if (event.data.selected.length == 1) {
                                    ...
                                    if (!item.hasClass('directory')) {
                                        ...
                                        $.ajax({
                                            ...
                                            url: '/sku/selectFile',
                                            data: { t");
                WriteLiteral(@"arget: selectedFile },
                                            success: function (data) {
                ...
                goAnchor(selector, index) {
                    ...
                    let dist");
                WriteLiteral(@"ance = document.documentElement.scrollTop || document.body.scrollTop
...
#nullable restore
#line 1424 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Sku\Inherite.cshtml"
...
#nullable disable
                WriteLiteral(@";
                    _self.currProduct.productId = productId;
       ...
       ");
                WriteLiteral(@"                 }
                    ...
                    if ((_self.currProduct.imageMain == undefined || _self.currProduct.imageMain == """") && (_self.currProduct.primaryImageSrc == undefined || _self.currProduct.primaryImageSrc == """")) {
                        _self.$message({
                            type: 'error',
                            message: '请上传产品示意图'
                        });
        ...
        ");
                WriteLiteral(@"            _self.currProduct.eBulletPoint = CKEDITOR.instances.editor2.getData();
                            ...
                            success: function (data) {
                                if (data.success == true) {
                                    _self.$notify({
                                        title: '成功',
                                        ");
                WriteLiteral(@"message: '创建sku成功！',
                                        type: 'success'
                                    });
                                  setTimeout(function () {
                                        window.parent.MainIndex.removeTab(""创建Sku_"" + ");
#nullable restore
#line 1483 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Sku\Inherite.cshtml"
                                                                                Write(ViewBag.productId);
...
#nullable disable
                ...
                inheriteProduct() {
                    ...
                    var productId = ");
#nullable restore
#line 1548 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Sku\Inherite.cshtml"
                               Write(ViewBag.productId);
                ...
                WriteLiteral(@"                   } else {
                                ...
                                if (_self.currProduct.packingSize != null) {
                                    ...
                                    if (arrPacking.length > 0) {
                                        ...
                                        _self.currProduct.packingSiz");
                WriteLiteral(@"eWidth = arrPacking[1];
