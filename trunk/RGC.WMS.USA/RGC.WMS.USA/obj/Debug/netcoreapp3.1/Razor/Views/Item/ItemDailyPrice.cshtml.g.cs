#pragma checksum "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Item\ItemDailyPrice.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "57b7f6fc2598e4853eaab271e82cc62220b1c523"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Item_ItemDailyPrice), @"mvc.1.0.view", @"/Views/Item/ItemDailyPrice.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"57b7f6fc2598e4853eaab271e82cc62220b1c523", @"/Views/Item/ItemDailyPrice.cshtml")]
    ...
    public class Views_Item_ItemDailyPrice : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Item\ItemDailyPrice.cshtml"
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "57b7f6fc2598e4853eaab271e82cc62220b1c5233783", async() => {
    ...
    ");
                ...
                WriteLiteral(@"              :label=""item.eName""
                                ...
                                <el-form-item label=""日期"" class=""mt10"">
                                    <el-date-picker v-model=""filters.dateR");
                WriteLiteral(@"ange""
                                                    type=""daterange""
...
");
                WriteLiteral("\r\n                                </el-form-item>\r\n");
                WriteLiteral(@"                                <el-form-item class=""mt10"">
...
");
                WriteLiteral("                        <el-table-column prop=\"dateString\" label=\"获取时间\" min-width=\"120\"></el-table-column>\r\n");
                WriteLiteral("\r\n");
...
");
        ...
        <el-dialog title=""编辑价格"" :visible.sync=""detailVisable"" :close-on-click-modal=""false"" top=""5%"" width=""50%"">
            <el-form :model=""itemDailyPriceForm"" label-width=""100px"" ref=""editForm"">
                <el-form-item label=""itemId"" prop");
                WriteLiteral(@"=""itemId"">
...
");
             ...
             ");
                ...
                WriteLiteral(@"        },
                    ...
                    if (_self.dailyPriceData.length > 0) {
                        console.log(_");
                WriteLiteral(@"self.dailyPriceData[0])
  ...
  ");
                WriteLiteral(@"                              var item = {
                                ...
                                for (var p in _self.dailyPriceData) {
                                    if (_self.dailyPriceData[p].platformId == _self.platformList[key].id) {
                                        item.dataPoints.push({ x: new Date(_self.dailyPriceData[p].date.substring(0, 4), parseInt(_self.dailyPriceData[p].date.substring(5, 7)) - 1, _self.dailyPriceData[p].date.substring(8, 10)), y: parseFloat(_self.dailyPriceData[p].priceString) })
                            ");
                WriteLiteral(@"            //console.log(_self.dailyPricelist[p].date.substring(0, 4) + _self.dailyPricelist[p].date.substring(5, 7) + _self.dailyPricelist[p].date.substring(8, 10))
                                    }
                                }
                                chartdata.data.push(item);
                            }
                        ...
                        setTimeout(() => {
                            ...
                            this.searchItemList = this.itemList.filter(item => {
                                return item.itemName != null ? (item.itemName.toLowerCase()
                                    .indexOf(query.toLowerCase()) > -1 || item.factoryModel.toLowerCase().indexOf(query.toLower");
                WriteLiteral(@"Case()) > -1) : [];
                            });
                        }, 200);
                    } else {
    ...
    ");
                WriteLiteral(@"                _self.itemDailyPriceForm.platformId = void 0;
    ...
    ");
                WriteLiteral(@"                        _self.skuListLoading = false;
                ...
                getPlatformList() {
                    var _self = this;
                    _s");
                WriteLiteral(@"elf.listLoading = true;
                    $.ajax({
                        type: 'GET',
                        dataType: 'json',
                ...
                WriteLiteral(@"uccess: function (data) {
                        ...
                        error: function (XMLHttpRequest, textStatus, errorThrown) {
                            ...
                            if (errorThrown == ""Unauthorized"") {
                                window.par");
                WriteLiteral(@"ent.MainIndex.openLoginFrom();
                                _self.$message({
                                    type: 'error',
                                    message: XMLHttpRequest.responseJSON.msg
                                });
                ...
                getChartDailyPriceList: function () {
                    ...
                    $.ajax({
                        ...
                        url: '/rest/item/dailyprice/list',
                         data: JSON.stri");
                WriteLiteral(@"ngify(_self.filters2),
                        success: function (data) {
                            _self.loading = false;
...
");
                WriteLiteral(@"                            || _self.itemDailyPriceForm.date == undefined) {
                            _self.$message({
                                type: 'error',
                                message: '信息不全,无法保存'
                            });
  ...
  ");
           ...
           ");
            ...
            created() {
                ...
                _self.filters.da");
                WriteLiteral(@"teRange.push(dateFormatter(new Date(),false))
    ...
    ");
                WriteLiteral(@"     function getColor(id) {
            console.log(name)
            switch (id) {
                case 1:
                    return ""#F08080"";
   ...
   ");
                WriteLiteral(@"         var hasTime = arguments[1] != false ? true : false;//可传第二个参数false，返回yyyy-MM-dd
            var d = new Date(str);
