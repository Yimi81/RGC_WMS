#pragma checksum "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Item\Add.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "336fac85fd434c561a77c773f20a6abdadf947e3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"336fac85fd434c561a77c773f20a6abdadf947e3", @"/Views/Item/Add.cshtml")]
    ...
    public class Views_Item_Add : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #line hidden
        ...
        {
#nullable restore
#line 1 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Item\Add.cshtml"
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "336fac85fd434c561a77c773f20a6abdadf947e36020", async() => {
                WriteLiteral("\r\n    <div id=\"wrapper\">\r\n        <!-- 标题和地址 -->\r\n        <el-row>\r\n            <el-col :span=\"24\" class=\"breadcrumb-container pl20\">\r\n");
                WriteLiteral("                <el-breadcrumb separator=\"/\">\r\n");
                WriteLiteral(@"                    <el-breadcrumb-item><strong>在售产品管理</strong></el-breadcrumb-item>
        ...
        <template>
            <article class=""administration-maintenance-container"" v-loading=""loading"">
                <div ref=""nav_sku"" id=""nav_sku"">
                    ...
                    <el-form :inline=""true"" :model=""currProduc");
                WriteLiteral(@"t"" ref=""currProduct"" label-width=""300px"" class=""skuform"" label-position=""right"" size=""mini"">
                        ...
                        <el-card class=""box-card mb20 pl20"" shadow=""hover"" :body-style=""{padding:'0px'}"">
                            ...
                            <el-row>
                                <el-form-item label=""ProductId"" prop=""productId"">
                                    <el-input v-model=""currPro");
                WriteLiteral(@"duct.productId"" disabled>
                                ...
                                <el-row>
                                    ...
                                    <el-form-item label=""Model(型号)"" prop=""factoryModel"" :rules=""[{ required: true, message: '请输入型号', trigger");
                WriteLiteral(@": 'blur' }]"">
                                ...
                                <el-row>
                                    <el-form-item label=""MAP"">
                                        <el-input-number v-model=""currProduct.mapString"" :controls=""false"" :min=""0"" :precision=""2"" class=""w259""></el-input-num");
                WriteLiteral(@"ber>
                                    </el-form-item>
                                ...
                                <el-row>
                                    <div style=""width:574px;display:inline-block;float:left;"">
                                        <el-form-item label=""平台"" prop=""platformId"" style=""margin");
                WriteLiteral(@"-right:0;"" :rules=""[{ required: true, message: '请选择平台', trigger: 'change' }]"">
              ...
              ");
                WriteLiteral(@"                      <div style=""width:570px;display:inline-block;"">
                                ...
                                <el-row>
                                    <el-fo");
                WriteLiteral(@"rm-item label=""Picture(产品示意图) (320*320)"" prop=""imageMain"">
                        ...
                        <el-card shadow=""hover"" v-if=""currProduct.isSpecial"" class=""mb20 pl20"" :body-style=""{padding:'0px'}"">
                            <div slot=""header"">
                                <span slot=""header"" class=""step-jump pr"" id=""sku_baseInfo"">
                   ");
                WriteLiteral(@"                 <i class=""tip-tit""><i class=""pr z-in2 pl10"">关联产品</i></i>
                                </span>
                            </div>
                ...
                WriteLiteral(@"          </el-table-column>
                                ...
                                <el-table-column label=""操作"" min-width=""150"" fixed=""right"">
                                    <template slot-scope=""scope"">
                                        ...
                                        <el-button size=""mini"" type=""danger"" plain v-on:click=""itemProduc");
                WriteLiteral(@"t.splice(scope.$index , 1)"">
                                            移 除
                        ...
                        <el-row class=""toolbar"">
                            <article class=""search"">
                                <section>
                                    ...
                                    <el-");
                WriteLiteral(@"button v-on:click=""search"" size=""mini"" icon=""el-icon-search"">搜索</el-button>
                                </section>
                            </article>
                        </el-row>
...
");
                WriteLiteral(@"                            <el-table-column min-width=""40"" prop=""id"" label=""ID"">
                                <template slot-scope=""scope"">
                                    <i>{{scope.row.id}}</i>
                                </template>
                            </el-table-column>
                            ...
                            <el-table-column prop=""status"" label=""状态"" width=""110"">
                                <template slot-scope=""scope"">
                                    ");
                WriteLiteral(@"<el-tag size=""small"" v-if=""scope.row.status == 0"">录入中</el-tag>
                ...
                WriteLiteral(@"            <i v-if=""scope.row.funcCategory!=null"">{{scope.row.funcCategory.eName}}</i>
                            ...
                            <el-table-column min-width=""60"" prop=""createUser"" label=""创建人"">
                                <template slot-scope=""scope"">
                                    <i>{{sco");
                WriteLiteral(@"pe.row.createUser}}</i>
                                </template>
                            </el-table-column>
                            <el-table-column label=""操作"" min-width=""200"" fixed=""right"">
                                <template slot-scope=""scope"">
                                    ...
                                    <el-row>
                                        <el-button size=""mini"" v-i");
                WriteLiteral(@"f=""currProduct.isSpecial&&scope.row.id!=currProduct.productId"" v-on:click=""addItemProduct(scope.row)"">添加关联</el-button>
                    ...
                    <el-dialog title=""附件 Attachment"" :visible.sync=""fileManageVisable"" :close-on-click-modal=""false"" top=""5%"" width=""1000px"">
                        ...
                        <span slot=""foo");
                WriteLiteral(@"ter"" class=""dialog- footer"" style=""display:block;text-align: center;margin-top: 20px"">
        ...
        var Main = {
            data() {
                return {
                    ...
                    partVisable: false,
                ");
                WriteLiteral(@"    fittingVisable: false,
                    listLoading: false,
                    newPartList: [],
                    newPartPackageList: [],
                    newFittingList: [],
                ...
                WriteLiteral(@": [1],
                    ...
                    loading: false,
                  ");
                WriteLiteral(@"  dialogVisible: this.visible,
                    currProduct: {
                        status: 0,
                        isSpecial: false,
                        itemName: void 0,
            ...
            methods: {
                 addProductId(row) {
                    ...
                    for (let key in _self.itemProduct) {
                        if (_self.itemProduct[key].prod");
                WriteLiteral(@"uctId == row.productId) {
                ...
                save(isSync) {
                    var _self = this;
                     var _valid = false;
                    this.$ref");
                WriteLiteral(@"s['currProduct'].validate((valid) => {
                        if (valid) {
                            _valid = true;
                        }
                    });
         ...
         ");
                ...
                handleCurrentChange(val) {
                    this.page = val;
        ");
                WriteLiteral(@"            this.getProductList();
                },
                getProductList() {
                    ...
                    for (let key in _self.gridData)
                    {
                        if (_self.gridChecked.indexOf(_self.gridData[key].configDetailId) > -1) {
                            ...
                            for (let item in _self.currProduct.fittingChildren[index1].children[index2].detailList) {
                                if (_self.currProduct.fittingChi");
                WriteLiteral(@"ldren[index1].children[index2].detailList[item].configDetailId==_self.gridData[key].configDetailId) {
                                    i++;
                                }
                            }
                            console.log(i)
...
");
                                    ...
                                    if (!item.hasClass('directory')) {
                                        ...
                                        $.ajax({
                                           type: 'post',
                                            url: '/item/selectFile',
                                            data: { ");
                WriteLiteral(@"target: selectedFile },
                                            success: function (data) {
                ...
                fetchData() {
                    setTimeout(() => {
                        ...
                        //渲染富文本框
                        this.descEditor = CKEDITOR.replace");
                WriteLiteral(@"(""editor1"", {
                            uiColor: '#EFF2F7',
                            height: '300px',
                        });
