#pragma checksum "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Home\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a0df0db20cd14c7ac62c03be9d1d86d32dbc5d81"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a0df0db20cd14c7ac62c03be9d1d86d32dbc5d81", @"/Views/Home/Index.cshtml")]
    ...
    public class Views_Home_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Home\Index.cshtml"
...
#nullable disable
    ...
    <style>
        ...
        .iframe_load {
            ...
            right: 0;
            margin: auto;
            background-image: url(""/images/home/if");
                WriteLiteral(@"rame_load.gif"");
...
<div class=""h100b of"">
    ...
    <div id=""wrapper"" class=""h100b"" v-cloak>
        <el-header class=""topbar"" height=""50"">
            ...
            EndWriteAttribute();
            WriteLiteral(" class=\"leftside_logo--big\">\r\n                </span>\r\n                <!-- 操作 -->\r\n                <div class=\"operation\">\r\n                    <p class=\"operation_user\">\r\n");
#nullable restore
#line 118 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Home\Index.cshtml"
...
#nullable disable
#nullable restore
#line 120 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Home\Index.cshtml"
                       Write(name);
...
#nullable disable
            ...
            WriteLiteral(@">
                                <div class=""operation_line"">
                                    ...
                                    <div v-if=""dialogMe.user.id > 0""><a v-on:click=""editUserPassword(dialogMe.user.userId)"">修改密码</a></div>");
            WriteLiteral(@"
        ...
        <el-container class=""h100b"">
            ...
            <el-aside class=""leftside h-auto"" v-bind:style=""{ width:'auto',height: iframeHeight+'px' }"">
                <el-scrollbar style=""height:100%"">
                    <el-menu :collapse=""isCollapse"">
                        <!-- 折叠菜单 按钮 -->
                  ");
            WriteLiteral(@"      <el-menu-item index=""0"" class=""leftside_title"" v-on:click=""toggleCollapse"">
                        ...
                        <template v-for=""menu in menus"">
                            ...
                            <!-- 有二级子菜单 -->
                            <el-submenu v-if=""menu.children.length>0&&menu.type==1"" :index=""menu.id.toString");
            WriteLiteral(@"()"" :key=""menu.id"">
                                <template slot=""title"">
                                    <i :class=""['iconfont',menu.icoName]""></i>
                                    <span slot=""title"">{{menu.name}}</span>
                                </template>
            ...
            <el-container class=""rightcont"">
                <el-tabs id=""toptabs"" class=""toptabs"" type=""card"" v-model=""toptabsValue"" closable v-on:tab-remove=""removeTab"">
                    <el-tab-pane v-for=""(item, index) in ");
            WriteLiteral(@"toptabs""
                                 :key=""item.name""
                                 :label=""item.title""
                                 :name=""item.name"">
                        <!-- tabs对应内容 -->
...
");
            WriteLiteral(@"        <el-dialog title=""个人信息""
            ...
            <el-form :model=""dialogMe.user"" :rules=""rules"" ref=""form"" label-width=""100px"">
                ...
                <el-form-item label=""联系电话"" prop=""mobile"">
                   ");
            WriteLiteral(@" <el-input v-model=""dialogMe.user.mobile"" placeholder=""联系电话""></el-input>
                </el-form-item>
        ...
        <el-dialo");
            ...
            <span slot=""footer"" class=""dialog-footer"">
                <el-button v-on:click=""dialogPwd.i");
            WriteLiteral(@"sShow = false"">取消</el-button>
        ...
        <el-dialog title=""请登录"" :visible.sync=""loginForm.isShow"" :close-on-click-modal=""false"" v-on:keyup.enter.native=""submitForm('loginForm')"" size=""tiny"">
            <el-form :model=""loginForm"" :rules=""loginFormRules"" ref=""loginForm"" v-loading=""loginLoading"">
                ...
                <el-form-item prop=""yzm"" class=""login-panel__yzm"">
                    <el-input placeholder=""请输入验证码"" prefix-icon=""el-icon-third-msnui-auth-code"" v-model=""loginForm.yzm""></el");
            WriteLiteral(@"-input>
...
");
    ...
    <script>
        var MainIndex = new Vue({
          ...
          ");
                WriteLiteral(@"          iframeHeight: 600,//iframe默认高度
                    // 左侧菜单列表
                    menus: [
                        //{
                        //    id: 1,
            ...
            ");
                ...
                //【移除右侧标签页面】
      ");
                WriteLiteral(@"          removeTab(targetName) {
                    let tabs = this.toptabs;
 ...
 ");
                ...
                WriteLiteral(@"        });
                            ...
                            cons");
                WriteLiteral(@"ole.log('error submit!!');
                            return false;
                        }
                    })
    ...
    ");
                                        ...
                                        $('iframe').each(function () {
                                            if ($(this).css(""display"") != ""none"") {
                                                if ($(this).attr('src') == ""dashboard"") {
                                                    ...
                                                    _se");
                WriteLiteral(@"lf.$confirm('是否刷新当前页?', '提示', {
                                                        type: 'warning'
                                                    }).then(() => {
                ...
                openLoginFrom() {
                    ...
                    _self.loginForm = {
                        ...
                        password: '',
                        yzm: '',
                        validateCode: '/home/validateCo");
                WriteLiteral(@"de?' + Math.random(),
                    };
