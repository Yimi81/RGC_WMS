#pragma checksum "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Sku\Add.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "d2d1cb31212a829cdc9dc26c3172dd12f96ad39d"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Sku_Add), @"mvc.1.0.view", @"/Views/Sku/Add.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"d2d1cb31212a829cdc9dc26c3172dd12f96ad39d", @"/Views/Sku/Add.cshtml")]
    ...
    public class Views_Sku_Add : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#nullable restore
#line 1 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Sku\Add.cshtml"
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "d2d1cb31212a829cdc9dc26c3172dd12f96ad39d5968", async() => {
                            ...
                            <el-tab-pane label=""基本信息及参数"" name=""first"">
                                <el-card class=""box-card"" shadow=""hover"">
                                    <span slot=""header"" class=""step-jump pr"" id=""sku_baseInfo"">
                                      ");
                WriteLiteral(@"  <i class=""tip-tit""><i class=""pr z-in2 pl10"">基本信息</i></i>
                                    </span>
                                    <el-form-item label=""Product Id(产品Id)"" prop=""productId"">
                                        <el-input v-model.trim=""currProduct.productId"" disabled></el-input>

                                    </el-form-item>
                                    <el-form-item label=""Product Name(产品名称)"" prop=""fullEName"" :rules=""[{ required: true, message: '请输入产品名称', trigger: 'blur' }]"">
                                        <el-input v-model.trim=""currProduct.fullEName""></el-input>
                                    </el-form-item>
                                    <el-form-item label=""Model(型号)"" prop=""factoryModel"" :rules=""[{ required: true, message: '请输入型号', trigger: 'blur' }]"">
                                        <el-input v-model.trim=""currProduct.factoryModel""></el-input>
                                    </el-form-item>
");
                WriteLiteral(@"                                    <el-form-item label=""Category(分类)"" prop=""funcCategoryIds"" :rules=""[{ required: true, message: '请选择', trigger: 'blur' }]"">
                                        <el-cascader class=""w178""
                                                     :options=""cascader""
                                    ...
                                    <el-form-item label=""SKU"">
                                        <el-input v-model.trim=""currProduct.sku""></el-input>
                                    </el-form-item>
                                    <el-form-item label=""UPC"">
                                        <el-input v-model.trim=""currProduct.upc""></el-input>
  ");
                WriteLiteral(@"                                  </el-form-item>
                                    <el-form-item label=""Certification(认证)"">
                                        <el-input v-model.trim=""currProduct.certification""></el-input>
                                    </el-form-item>
");
                WriteLiteral(@"                                    <el-form-item label=""Package Configuration(包装配置)"">
                                        <el-input v-model.trim=""currProduct.packingConfig""></el-input>
                                    </el-form-item>
                                    <el-row>
                                       ...
                                       ");
                WriteLiteral(@"     <el-tag type=""info"" size=""small"">inch</el-tag>
                                        </el-form-item>
                       ...
                       ");
                WriteLiteral(@"             <el-form-item label=""Net Weight (净重)"" prop=""netWeight"">
                                        <el-input-number class=""w140"" controls-position=""right"" :precision=""1"" :step=""0.1"" :min=""0.0"" v-model.trim=""currProduct.netWeight""></el-input-number>
                                        <el-tag type=""info"" size=""small"">LB</el-tag>
                                    </el-form-item>
                                    <el-form-item label=""Gross Weight (毛重)"" prop=""grossWeight"">
                                        <el-input-number class=""w140"" controls-position=""right"" :precision=""1"" :step=""0.1"" :min=""0.0"" v-model.trim=""currProduct.grossWeight"">
                                        </el-input-number>
                                        <el-tag type=""info"" size=""small"">LB</el-tag>
                                    </el-form-item>
                                    <el-form-item label=""qty/pallet(1托数量)"">
                                        <el-input-number class=""w178"" :contr");
                WriteLiteral(@"ols=""false"" :precision=""0"" :min=""0.0"" v-model.trim=""currProduct.qtyPallet"">
                                        </el-input-number>
                                    </el-form-item>
                                    <el-form-item label=""qty/40HQ(40HQ装柜数)"">
                                        <el-input-number class=""w178"" :controls=""false"" :precision=""1"" :min=""0.0"" v-model.trim=""currProduct.loadingQty_40HQ"">
                                        </el-input-number>
                                    </el-form-item>
                                    ...
                                    <el-row class=""pl90"">
                                        <el-form size=""mini"" :inline=""true"" v-model=""Custom"">
                                            <el-form-item v-for");
                WriteLiteral(@"=""(item,index) in Custom"" :key=""index"">
                                                <el-row :gutter=""12"">
                                                    <el-col :span=""10"">
                                                        <el-col :span=""12"">
                ...
                WriteLiteral(@"        <el-col :span=""10"">
                                    ...
                                    <el-row>
                                        <el-form-item label=""Remark (产品备注)"" label-width=""220px"">
                                            <el-input v-model=""currProduct.remark"" type=""textarea"" :rows=""4""
          ");
                WriteLiteral(@"                                            placeholder=""Remark (产品备注)"" class=""w365"" />
                                        </el-form-item>
                                    </el-row>
                                </el-card>
                            </el-tab-pane>
");
                WriteLiteral(@"                            <el-tab-pane label=""产品配置/详情"" name=""second"">
                                <el-card class=""box-card"" shadow=""none"">
                                    ...
                                    <el-table empty-text="" "" max-height=""150""
                                        ...
                                        <el-table-c");
                WriteLiteral(@"olumn label=""材质 Material"" width=""100"" align=""center""></el-table-column>
   ...
   ");
                WriteLiteral(@"                                                 <el-table-column prop=""material"" width=""100"" align=""center"">
                                                        <template slot-scope=""scope"">
                                                            <el-input size=""small"" v-model=""scope.row.material"" style=""width: 100%;"" />
                                                        </template>
                                                    </el-table-column>
                                                    <el-table-column prop=""surface"" width=""200"" align=""center"">
                                                        <template slot-scope=""scope"">
                                                            <el-input size=""small"" v-model=""scope.row.surface"" style=""width: 100%;"" />
                                                        </template>
                                                    </el-table-column>
                                                    <el-table-column pr");
                WriteLiteral(@"op=""remarks"" align=""center"">
                                                        <template slot-scope=""scope"">
                                                            <el-input size=""small"" type=""textarea"" v-model=""scope.row.remarks"" />
                                                        </template>
                                                    </el-table-column>
                                                </el-table>
                                            </template>
                       ...
                       ");
                WriteLiteral(@"             <el-button size=""mini"" plain v-on:click=""getFittingList()"">添加配件</el-button>
                                    <el-table empty-text="" "" max-height=""150""
                                              style=""width: 100%;margin-bottom:0px;"" border class=""gvq hide-empty mt20"" size=""mini"">
                                        <el-table-column label=""组件名称 Unit"" width=""150""></el-table-column>
       ...
       ");
                WriteLiteral(@"                                 <el-table-column width=""150"">
                                            <template slot-scope=""scope"">
                                                {{scope.row.cName}}
                                                <br />
                                                {{scope.row.eName}}
                                        ...
                                        <el-table-column>
                                            <template slot-scope=""scope1"">
                                                <el-table :fit=""true""
                                                          ...
                                                          :data=""scope1.row.children"">
                                        ");
                WriteLiteral(@"            <el-table-column width=""200"" align=""center"">
                                                        <template slot-scope=""scope"">
                                                            {{scope.row.cName}}
                                                            <br />
                                                            {{scope.row.eName}}
                                                            ...
                                                            <el-popover placement=""right""
                                                                ...
                                                                <el-tree :data=""gridData""
                                                                         ...
                                                                         default-expand-all
                                           ");
                WriteLiteral(@"                              :default-checked-keys=""gridChecked""
                                                         ...
                                                         ");
                WriteLiteral(@"       <el-button v-on:click=""chooseDetail('gridTree'+scope.row.configId,scope1.$index,scope.$index)"" :disabled=""gridData.length<=0"" size=""mini"" type=""success"" plain>选择</el-button>
                                                                ...
                                                                <el-table-column width=""200"">
                                                                    <template slot-scope=""scope3"">
                                                                        <el-popover placement=""top-start""
                                                                            ...
                                                                            <p>确定删除该描述?</p>
                                                                            <div class=""tr mt10"">
                                                                                <el-button size=""mini"" type=""warning"" v-");
                WriteLiteral(@"on:click=""scope3.row.visible = false"" plain>取消</el-button>
                ...
                WriteLiteral(@"/el-table-column>
                                                                <el-table-column prop=""remarks"" align=""center"">
                                                                    <template slot-scope=""scope3"">
                                                                        <el-input type=""textarea"" v-model=""scope3.row.remarks"" />
                                                                    </template>
                                                                </el-table-column>
                                                            </el-table>
                                                            <table v-else class=""w100b"" style=""border:0;min-height:87px;"">
                                                                <tr>
                                                                    <td width=""199""></td>
                                                                    <td><div class=""cell""><el-input type=""textarea"" v-model=""scope2.row.re");
                WriteLiteral("marks\" /></div></td>\r\n                                                                </tr>\r\n                                                            </table>\r\n");
                WriteLiteral(@"                                                        </template>
                            ...
                            <el-tab-pane label=""产品卖点"" name=""third"">
                                <el-card class=""box-card"" shadow=""hover"">
                                    ...
                                    <el-form-item label=""描述"" prop=""desc"" label-width=""auto"">
                                        <textarea id=""editor1"" name=""editor1"" v-");
                WriteLiteral(@"model.trim=""currProduct.bulletPoint""></textarea>
                                    </el-form-item>
                                </el-card>
                            </el-tab-pane>
       ...
       ");
             ...
             ");
                WriteLiteral(@"               src: void 0,
                        ...
                        packingSizeWidth: 0,
       ");
                WriteLiteral(@"                 packingSizeHeight: 0,
                        netWeight: void 0,
                        grossWeight: void 0,
            ...
            methods: {
                ...
                getDetailList(row) {
                    ...
                    ");
                WriteLiteral(@"            _self.gridData = data.data
                    ...
                    for (let parent of this.currProduct.fittingChildren) {
                        ...
                        if (parent.children.length > 0) {
                          //子级选中
                            for (let child of parent.children) {
                                this.");
                WriteLiteral(@"newFittingChecked.push(child.configId)
                            }
                        } else {
...
");
                WriteLiteral(@"                                item: model[key].eName + "" "" + model[key].cName,
                    ...
                    this.Configuration[this.no].child.push(
                        {
                           ...
                           ");
                WriteLiteral(@" cName: this.ChildData[index].cName,
                ...
                batchAddChild() {
                    ...
                    if (this.multipleSelection.length > 0) {
                     ...
                     ");
                WriteLiteral(@"               cName: _self.multipleSelection[key].cName,
     ...
     ");
                WriteLiteral(@"               var elementHtml = createElement('span', [
     ...
     ");
                ...
                getFittingList() {
                    ...
                    $this.ne");
                WriteLiteral(@"xtFittingVisable = false;
                    $.ajax({
                        type: 'Get',
         ...
         ");
                ...
                openAttachment() {
                    window.parent.MainIndex.addTabByIframe(""附件管理"", ""/sku/A");
                WriteLiteral(@"ttachment"", ""附件管理"");
                },
                delSet(index, row) {
      ...
      ");
                ...
                fileManageInitial() {
                    var _self = this;
                    var myCommands = elFinder.prototype._o");
                WriteLiteral(@"ptions.commands;
...
");
       ...
       ");
                WriteLiteral(@"             var _self = this;
                    ...
                    _self.currProduct");
                WriteLiteral(@".customList = _self.Custom
        ...
        ");
                WriteLiteral(@"            _self.currProduct.packingSize = _self.currProduct.packingSizeLength + 'x' + _self.currProduct.packingSizeWidth + 'x' + _self.currProduct.packingSizeHeight;
                    _self.loading = true
                    try {
                        $.ajax({
                            type: 'POST',
      ...
      ");
               ...
               ");
                WriteLiteral(@"         warmingRackArea: void 0,
                       ...
                       ");
                WriteLiteral(@" searBurnerPower: void 0,
                        power: void 0,
                        grillCover: void 0,
                        grillHandbag: void 0,
                ...
                //    // 586、");
                WriteLiteral(@"1063分别为第二个和第三个锚点对应的距离
                ...
                //        else if (scrolled == 0) {
                //            this.active = 0
                //        } else if (scrolled + windowHeight == sc");
