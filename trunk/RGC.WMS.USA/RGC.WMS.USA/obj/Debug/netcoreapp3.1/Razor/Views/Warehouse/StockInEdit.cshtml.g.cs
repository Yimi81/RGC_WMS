#pragma checksum "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Warehouse\StockInEdit.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6a19efc5e72725a9d78a61d80b00ffdacd41b9bc"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Warehouse_StockInEdit), @"mvc.1.0.view", @"/Views/Warehouse/StockInEdit.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6a19efc5e72725a9d78a61d80b00ffdacd41b9bc", @"/Views/Warehouse/StockInEdit.cshtml")]
    ...
    public class Views_Warehouse_StockInEdit : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Warehouse\StockInEdit.cshtml"
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("body", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6a19efc5e72725a9d78a61d80b00ffdacd41b9bc4336", async() => {
                WriteLiteral(@"
    <div id=""wrapper"">
        <!-- 标题和地址 -->
        <el-row>
...
");
#nullable restore
#line 43 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Warehouse\StockInEdit.cshtml"
...
#line hidden
#nullable disable
                WriteLiteral("                            <el-breadcrumb-item>编辑发货入库单</el-breadcrumb-item>\r\n");
#nullable restore
#line 47 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Warehouse\StockInEdit.cshtml"
                        }
                        else
                        {
...
#line hidden
#nullable disable
                WriteLiteral("                            <el-breadcrumb-item>添加发货入库单</el-breadcrumb-item>\r\n");
#nullable restore
#line 51 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Warehouse\StockInEdit.cshtml"
                        }
...
#nullable disable
        ...
        <template>
           ...
           ");
                WriteLiteral(@"                     <el-table-column label=""仓库"" prop=""warehouseNumber"" width=""45"" align=""center"">
                                    <template slot-scope=""scope"">
        ...
        ");
                WriteLiteral(@"                                    <el-button slot=""reference"" type=""danger"" size=""mini"" icon=""el-icon-delete"" circle plain></el-button>
                                        </el-popover>
                                    </template>
                                </el-table-column>
                                ...
                                <el-table-column label=""ETA"" p");
                WriteLiteral(@"rop=""eta"" width=""90"" align=""center"">
                                    <template slot-scope=""scope"">
                                        <i>{{scope.row.eta}}</i>
                                    </template>
                                </el-table-column>
       ...
       ");
                WriteLiteral(@"                         <el-table-column label=""实际到仓日期"" width=""155"" align=""center"">
                                    <template slot-scope=""scope"">
                                ...
                                <el-table-column label=""实际型号"" width=""120"" align=""center"">
                                    <template slot-scope=""scope"">
                                        ...
                                        <el-b");
                WriteLiteral(@"utton type=""primary"" plain v-on:click=""openSelectBatchView(scope.row)""
                                ...
                                <el-table-column label=""延迟原因"" prop=""reason"" align=""center"">
                                    <template slot-scope=""scope"">
      ");
                WriteLiteral(@"                                  <el-input v-model=""scope.row.reason"" type=""textarea"" :rows=""2"" size=""mini"" />
                                    </template>
                                </el-table-column>
                            </el-table>
                        </el-card>
                ...
                WriteLiteral(@"                              </template>
                           ...
                           ");
                WriteLiteral(@"         <el-table-column min-width=""80"" label=""合同号"" align=""center"">
                                        <template slot-scope=""scope"">
                                            <i>{{scope.row.contractNo}}</i>
                                        </template>
                                    </el-table-column>
                ...
                WriteLiteral(@"
                    ...
                    <el-dialog title=""选择产品批次"" :visible.sync=""batchListVisable"" :close-on-click-modal=""false"" top=""5%"" width=""1200px"">
                        ...
                        <el-row>
                            <el-col>
                                <el-table class=""data-table"" v-loading=""batchListL");
                WriteLiteral(@"oading"" :data=""batchList"" :fit=""true"" border size=""small"">
                                    <el-table-column min-width=""20"" prop=""id"" label=""序号"" align=""center"">
                                        <template slot-scope=""scope"">
                                            <i>{{scope.$index + 1}}</i>
                                        </template>
                                    ...
                                    <el-table-column width=""120"" label=""图片"" align=""center"">
                                        <template slot-scope=""scope"">
                                            <img v-if=""scope.row.sku.primaryIma");
                WriteLiteral(@"geSrcFull"" class=""pimg"" alt=""no image"" :src=""scope.row.sku.primaryImageSrcFull"" height=""50"">
                                        </template>
                                    </el-table-column>
                                    ...
                                    <el-table-column label=""状态"" width=""110"" align=""center"">
                                        <template slot-scope=""scope"">
                                            ...
                                            <el-tag size=""small"" ");
                WriteLiteral(@"v-if=""scope.row.status == 2"" type=""success"">已到货</el-tag>
                                    ...
                                    <el-table-column width=""100"" label=""操作"" align=""center"">
                                        <template slot-scope=""scope"">
                                            <el-button type=""primary"" size=""small"" class=""waves-effec");
                WriteLiteral(@"t mb5"" v-on:click=""chooseBatch(scope.row)"">
                                                选择
                                            </el-button>
                                        </template>
                                    </el-table-column>
    ...
    <script src=""/lib/elFinder/lib/jquery-ui/jquery-ui.min.js");
                WriteLiteral(@"""></script>
    ...
    ");
                ...
                getPackingList() {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            isDeleted: 1,
                ");
                WriteLiteral(@"            pageSize: $this.packingPageSize,
              ...
              ");
                ...
                choosePackingList: function (row) {
                    ...
                    if (stockInDetail) {
                        for (var i = 0; i < stockInDetail.length; i++) {
                            ...
                            this.tableEditStockIn.editD");
                WriteLiteral(@"ata.stockInList.push({
                                id: 0,
                ...
                WriteLiteral(@"   eta: newPush.eta,
                                ...
                                ataWarehouse: '");
#nullable restore
#line 579 "D:\SVN\RGC\RGC.WMS\trunk\RGC.WMS.USA\RGC.WMS.USA\Views\Warehouse\StockInEdit.cshtml"
                                          Write(DateTime.Now.ToDateZNString());
...
#nullable disable
                    ...
                    if (this.tableEditStockIn.editData.stockInList) {
                        for (let i = 0; i < this.tableEditStockIn.editData.stockInList.length; i++) {
                            if (this.tableEditStockIn.editData.stockInList[i].detailId === this.tableEditStockIn.editData.currentSelectBatchRowId) {
                                ...
                                this.table");
                WriteLiteral(@"EditStockIn.editData.stockInList[i].targetProductId = row.productId;
                            ...
                            if (data.success == true) {
                                ...
                                if (stockInDetail) {
                                    for (let i = 0; i < stockInDetail.length; i++) {
                                        ...
                                        $this.tableEditStockIn.editData.stockInLi");
                WriteLiteral(@"st.push({
                                            id: newPush.id,
                                            ...
                                            factoryModel: newPush.sku.factoryModel,
                                            ");
                WriteLiteral(@"qty: newPush.planInQty,
                                            etd: newPush.etd,
                                            eta: newPush.eta,
  ...
  ");
     ...
     ");
                WriteLiteral(@"                                   // 判断当前元素与上一个元素是否相同(第1和第2列)
      ...
      ");
                WriteLiteral(@"                      etd: tStockInDetail.etd,
